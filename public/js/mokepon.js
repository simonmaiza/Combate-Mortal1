...
let scorpion = new Mokepon('Scorpion', "./assets/scorpionFondo.png", 5, "./assets/scorpionCaraa.png")

let subzero = new Mokepon('SubZero', "./assets/subZeroFondo.png", 5, "./assets/subZeroCaraa.png")

let raiden = new Mokepon('Raiden', "./assets/raidenFondo.png", 5, "./assets/raidenCaraa.png")

const SCORPION_ATAQUES = [
...
scorpion.ataques.push(...SCORPION_ATAQUES)
subzero.ataques.push(...SUBZERO_ATAQUES)
raiden.ataques.push(...RAIDEN_ATAQUES)
            ...
            .then(function ({ enemigos }) {
                mokeponesEnemigos = enemigos.map(function (enemigo) {
                    ...
                    if (mokeponNombre === "Scorpion") {
                        mokeponEnemigo = new Mokepon('Scorpion', "./assets/scorpionFondo.png", 5, "./assets/scorpionCaraa.png", enemigo.id)
                    } else if (mokeponNombre === "SubZero") {
                        mokeponEnemigo = new Mokepon('SubZero', "./assets/subZeroFondo.png", 5, "./assets/subZeroCaraa.png", enemigo.id)
                    } else if (mokeponNombre === "Raiden") {
                        mokeponEnemigo = new Mokepon('Raiden', "./assets/raidenFondo.png", 5, "./assets/raidenCaraa.png", enemigo.id)
                    }
